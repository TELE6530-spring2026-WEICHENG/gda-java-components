...
public class GetActuatorCommandResourceHandler extends CoapResource implements IActuatorDataListener {
    ...
    public boolean onActuatorDataUpdate(ActuatorData data) {
        if (data != null) {
            ...
            super.changed(); // Notify observers of the change

            _Logger.info(
                    "OBSERVE: Published ActuatorData command from GDA to CDA: " + data.getCommand());

            _Logger.info("Actuator data updated for URI: " + super.getURI() + ": Data value = "
